  ...
  function onlinePayment() {
    ...
    axios
      .post(
        ...
        {
          headers: { token: localStorage.getItem("tkn") },
          params: { url: "https://BasselZeidan80.github.io/Anon-Ecommerce" },
        }
      )
      .then((res) => {
        console.log("res ", res);
        console.log("res success", shipping);
        if (res.data.status === "success") {
          toast.success("in progress will open strapi service ");
                ...
                <div className="form text-center px-4">
                  ...
                  <div className="mt-3 text-lg-start copon">
                    ...
                    <p>
                      ...
                      Animi natus nulla autem minima non est mollitia ab sunt
                      odio ut?
                    </p>
                  ...
                  <div className="TotalCart p-3  text-lg-start rounded-5 mt-3 ">
                    ...
                    <div className="d-flex ">
                      <button
                        type="submit"
                        className="w-50 fw-bold rounded-4 mt-1 mx-1  btn btn-light "
